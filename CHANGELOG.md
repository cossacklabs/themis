...
- **C++**
  ...
  - Secure Cell API updates ([#588](https://github.com/cossacklabs/themis/pull/588))
    ...
    - ThemisPP now supports _passphrase API_ of Secure Cell in Seal mode:
      ...
      Existing master key API is not secure when used with passphrases. You should only use it with symmetric encryption keys, such as generated by `themispp::gen_sym_key()` ([#561](https://github.com/cossacklabs/themis/pull/561)).
...
- **PHP**
  ...
  - PHPThemis now supports _passphrase API_ of Secure Cell in Seal mode ([#594](https://github.com/cossacklabs/themis/pull/594), [#601](https://github.com/cossacklabs/themis/pull/601)).
    ...
    Existing master key API (`phpthemis_scell_seal_{encrypt,decrypt}` and other modes) is not secure when used with passphrases. You should only use it with symmetric encryption keys, such as generated by `phpthemis_gen_sym_key()` ([#561](https://github.com/cossacklabs/themis/pull/561)).
