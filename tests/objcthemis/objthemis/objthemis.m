...
- (void)testSecureCellSealModeKeyGeneration {
    
    NSData * masterKeyData = [self generateMasterKey];
    TSCellSeal * cellSeal = [[TSCellSeal alloc] initWithKey:nil];
    XCTAssertFalse(cellSeal,"secure cell encrypter (Seal mode) creation error");
...
- (void)testSecureCellSealModeEncryptionDecryptionWithContext {
    ...
    NSData * encryptedMessage = [cellSeal wrapData:nil
                                           context:[context dataUsingEncoding:NSUTF8StringEncoding]
                                             error:&themisError];
    XCTAssertTrue(themisError, @"encryption without data-to-encrypt should return error");
    
    themisError = nil;
    encryptedMessage = [cellSeal wrapData:[message dataUsingEncoding:NSUTF8StringEncoding]
                                  context:[context dataUsingEncoding:NSUTF8StringEncoding]
                                    error:&themisError];
    XCTAssertFalse(themisError, @"encryption with data and context should be successful");
    
    NSData * decryptedMessage = [cellSeal unwrapData:encryptedMessage
                                             context:nil
                                               error:&themisError];
    XCTAssertTrue(themisError, @"decryption without context should return error");
    
    themisError = nil;
    decryptedMessage = [cellSeal unwrapData:encryptedMessage
                                    context:[context dataUsingEncoding:NSUTF8StringEncoding]
                                      error:&themisError];
    XCTAssertFalse(themisError, @"decryption with data and context should be successful");
...
- (void)testSecureCellSealModeEncryptionDecryptionWithoutContext {
    NSData * masterKeyData = [self generateMasterKey];
    TSCellSeal * cellSeal = [[TSCellSeal alloc] initWithKey:masterKeyData];
    NSString * message = @"All your base are belong to us!";
    NSString * context = @"For great justice";
    ...
    XCTAssertFalse(themisError, @"encryption with data and without context should be successful");

    NSData * decryptedMessageNoContext = [cellSeal unwrapData:encryptedMessageNoContext
                                                      context:[context dataUsingEncoding:NSUTF8StringEncoding]
                                                        error:&themisError];
    XCTAssertTrue(themisError, @"decrypt with context message that was encypted without context should return error");
    
    themisError = nil;
    decryptedMessageNoContext = [cellSeal unwrapData:encryptedMessageNoContext
                                             context:nil
                                               error:&themisError];
    XCTAssertTrue(!themisError, @"decryption without context should be successful");
...
- (void)testSecureCellSealModeEncryptionDecryptionMixed {
    ...
    XCTAssertTrue(![encryptedMessage isEqualToData:encryptedMessageNoContext],
...
- (void)SignVerify:(const char*)priv priv_length:(unsigned)priv_length public_key:(const char*)pub pub_length:(unsigned)pub_length{
    NSData *private_key=[[NSData alloc] initWithBytes: priv length:priv_length];
    NSData *public_key=[[NSData alloc] initWithBytes: pub length:pub_length];
    
    TSMessage * encrypter = [[TSMessage alloc] initInSignVerifyModeWithPrivateKey:private_key peerPublicKey:public_key];
...
- (void)testSecureMessage {

  char ec256_priv[]="\x52\x45\x43\x32\x00\x00\x00\x2d\x49\x87\x04\x6b\x00\xf2\x06\x07\x7d\xc7\x1c\x59\xa1\x8f\x39\xfc\x94\x81\x3f\x9e\xc5\xba\x70\x6f\x93\x08\x8d\xe3\x85\x82\x5b\xf8\x3f\xc6\x9f\x0b\xdf";
x12\xdf\xd2\x2f\x95\x6b\xc3\xbe\xc7\x35\x8\xea\x30\x37\x9b\xdb\x14\x3b\x96\x17\x5f\xe4\xe\x34\x58\xcb\xb4\x92\x1f\x16\x36\xd8\x82\x2b\xf3\x72\xf4\x15\x36\xa4\x76\x7b\x26\x11\x45\xfb\xe8\x5c\x7d\xb4\x86\x19\xc0\x1f\xd4\xca\x3b\x74\x7a\xca\x5b\x44\x73\xf1\xa9\x8e\xc6\x8\x3\xcb\x7e\x4c\x17\x71\x3d\x36\x95\x6f\x49\xb1\x3a\xc\x27\x62\xd0\x8f\x2b\xfe\xaa\xa8\x9a\x95\x14\xb6\xe9\xe4\x5c\x2\xf9\xcb\xd8\xad\x6c\xac\xd9\xdb\x92\x98\xf\x7f\xa2\xa7\x82\x7e\xfd\x73\xba\x31\xcc\x96\x64\x3c\xeb\x1a\x76\x12\x14\xa8\x9d\x82\xbe\xf8\xda\x85\x64\xf0\x48\x68\xbe\xa8\x2\x27\x9\xd8\xfe\x93\xb2\xb3\x9c\x6\x90\x9\x2f\xe7\x6c\xa2\xb4\x3e\x6c\x1a\x4e\x1\xad\x7d\xfd\x4c\xd4\x6e\xe6\x3b\x1c\x5e\x9d\x28\x8\xe2\x2d\x23\x9f\xd3\x88\xdd\x70\x5d\x6f\xad\x99\x0\x53\xb1\xb4\x7f\xc5\x32\x76\xff\x25\x29\xcc\xa1\x0\x73\x6a\xff\x24\x54\x80\x7d\xd5\x6b\x4d\x1a\x1f\x8b\xb5\x0\x1\x0\x1";
    ...
    [self EncDec:ec256_priv priv_length:sizeof(ec256_priv)-1 public_key:ec256_pub pub_length:sizeof(ec256_pub)-1];
    [self EncDec:rsa1024_priv priv_length:sizeof(rsa1024_priv)-1 public_key:rsa1024_pub pub_length:sizeof(rsa1024_pub)-1];
    [self EncDec:rsa2048_priv priv_length:sizeof(rsa2048_priv)-1 public_key:rsa2048_pub pub_length:sizeof(rsa2048_pub)-1];
    [self EncDec:rsa4096_priv priv_length:sizeof(rsa4096_priv)-1 public_key:rsa4096_pub pub_length:sizeof(rsa4096_pub)-1];
    [self SignVerify:ec256_priv priv_length:sizeof(ec256_priv)-1 public_key:ec256_pub pub_length:sizeof(ec256_pub)-1];
    [self SignVerify:rsa1024_priv priv_length:sizeof(rsa1024_priv)-1 public_key:rsa1024_pub pub_length:sizeof(rsa1024_pub)-1];
    [self SignVerify:rsa2048_priv priv_length:sizeof(rsa2048_priv)-1 public_key:rsa2048_pub pub_length:sizeof(rsa2048_pub)-1];
    [self SignVerify:rsa4096_priv priv_length:sizeof(rsa4096_priv)-1 public_key:rsa4096_pub pub_length:sizeof(rsa4096_pub)-1];
}
