...
- (void)testSecureMessageEC256 {
    NSString *privateKey = @"UkVDMgAAAC1JhwRrAPIGB33HHFmhjzn8lIE/nsW6cG+TCI3jhYJb+D/Gnwvf";
    NSString *publicKey = @"VUVDMgAAAC11WDPUAhLfH+nqSBHh+XGOJBHL/cCjbtasiLZEwpokhO5QTD6g";

    [self wrapUnwrapWithPrivateKey:privateKey publicKey:publicKey];
    [self signVerifyWithPrivateKey:privateKey publicKey:publicKey];
}
