...
response = smessage_rpc.call(smessage.wrap(b"This is test message!")); #encrypt and send message
response = smessage_rpc.call(smessage.wrap(b"This is test message #2!")); #encrypt and send message
response = smessage_rpc.call(smessage.wrap(b"This is test message #3!")); #encrypt and send message
response = smessage_rpc.call(smessage.wrap(b"This is test message #4!")); #encrypt and send message
