...
static NSString * kClientId = @"iTXLrWpRvrfemvI";
static NSString * kServerId = @"MPnfgMaTcWzgBcs";
static NSString * kServerPublicKey = @"VUVDMgAAAC3Dfw4AAkOntDfAdo6dCiScyLn5iZTCHC/EuAPtYGixwd69a83C";

// these two should generated by running `- (void)generateClientKeys`
static NSString * kClientPrivateKey = @"UkVDMgAAAC0Jznf+APripAmewhZrmAUJPtEbLNf9k/ZMVD4AEm4UrvDXezdM";
static NSString * kClientPublicKey = @"VUVDMgAAAC20Xw4LA2U1an4xYPPw9zrxgdcxm5zMLbHAzTpt5sCSopdlSHzB";
