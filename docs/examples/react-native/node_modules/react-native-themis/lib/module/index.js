...
const Themis = NativeModules.Themis ? NativeModules.Themis : new Proxy({}, {
  get() {
...
;
export function secureCellSealWithSymmetricKeyEncrypt64(symmetricKey64, plaintext) {
...
;
export function secureCellSealWithSymmetricKeyDecrypt64(symmetricKey64, encrypted64) {
  let context = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
...
;
export function secureCellSealWithPassphraseEncrypt64(passphrase, plaintext) {
  let context = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
...
;
export function secureCellSealWithPassphraseDecrypt64(passphrase, encrypted64) {
  let context = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
...
export function secureCellTokenProtectEncrypt64(symmetricKey64, plaintext) {
  let context = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
...
export function secureCellTokenProtectDecrypt64(symmetricKey64, encrypted64, token64) {
...
export function secureMessageVerify64(signed64) {
