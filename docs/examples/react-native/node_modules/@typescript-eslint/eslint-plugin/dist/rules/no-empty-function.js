    ...
    create(context, [{ allow = [] }]) {
        ...
        function isAllowedEmptyDecoratedFunctions(node) {
            ...
            if (isAllowedDecoratedFunctions && isBodyEmpty(node)) {
                const decorators = node.type === experimental_utils_1.AST_NODE_TYPES.FunctionDeclaration
                    ? node.decorators
                    : ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === experimental_utils_1.AST_NODE_TYPES.MethodDefinition
