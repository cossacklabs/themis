...
function getSavedComponentFilters() {
  try {
    var raw = Object(storage["a" /* localStorageGetItem */])(constants["a" /* LOCAL_STORAGE_FILTER_PREFERENCES_KEY */]);
...
function getAppendComponentStack() {
  try {
    var raw = Object(storage["a" /* localStorageGetItem */])(constants["d" /* LOCAL_STORAGE_SHOULD_PATCH_CONSOLE_KEY */]);
...
function getBreakOnConsoleErrors() {
  try {
    var raw = Object(storage["a" /* localStorageGetItem */])(constants["c" /* LOCAL_STORAGE_SHOULD_BREAK_ON_CONSOLE_ERRORS */]);
...
function getHideConsoleLogsInStrictMode() {
  try {
    var raw = Object(storage["a" /* localStorageGetItem */])(constants["b" /* LOCAL_STORAGE_HIDE_CONSOLE_LOGS_IN_STRICT_MODE */]);
...
function getShowInlineWarningsAndErrors() {
  try {
    var raw = Object(storage["a" /* localStorageGetItem */])(constants["e" /* LOCAL_STORAGE_SHOW_INLINE_WARNINGS_AND_ERRORS_KEY */]);
  ...
  switch (type) {
    ...
    case 'array':
      if (showFormattedValue) {
        ...
        var length = hasOwnProperty.call(data, hydration["b" /* meta */].size) ? data[hydration["b" /* meta */].size] : data.length;
...
/* harmony import */ var shared_isArray__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/* harmony import */ var _DevToolsFiberComponentStack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(20);
...
// EXTERNAL MODULE: ../react-devtools-shared/src/utils.js + 2 modules
  ...
  if (null === A) {
    ...
    try {
      D.useContext({
        ...
        return a;
      }, null), D.useRef(null), "function" === typeof D.useCacheRefresh && D.useCacheRefresh(), D.useLayoutEffect(function () {}), D.useInsertionEffect(function () {}), D.useEffect(function () {}), D.useImperativeHandle(void 0, function () {
        return null;
  ...
  for (var f = [], c = null, m = f, r = 0, t = [], v = 0; v < b.length; v++) {
    ...
    b: {
      ...
      if (void 0 !== p) for (g = 0; g < p.length && g < n.length; g++) {
        if (p[g].source !== n[g].source) {
          g < n.length - 1 && I(n[g].functionName, u.primitive) && g++;
          g < n.length - 1 && I(n[g].functionName, u.primitive) && g++;
          n = g;
          break b;
        }
    ...
    if (null !== l) {
      ...
      for (c = l.length - d - 1; 1 <= c; c--) {
        d = [], n = l[c], (p = l[c - 1].functionName) ? (g = p.lastIndexOf("."), -1 === g && (g = 0), "use" === p.substr(g, 3) && (g += 3), p = p.substr(g)) : p = "", p = {
          id: null,
          isStateEditable: !1,
          name: p,
          value: void 0,
...
function P(a, b, c, e, d) {
  ...
  } else if ("object" === k) throw b = String(a), Error(z(31, "[object Object]" === b ? "object with keys {" + Object.keys(a).join(", ") + "}" : b));
  return h;
}
...
exports.unstable_useInsertionEffect = function (a, b) {
...
exports.unstable_useSyncExternalStore = function (a, b, c) {
...
exports.version = "18.0.0-experimental-2825a08dc-20210930";
...
var agent_Agent = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Agent(bridge) {
    ...
    if (Object(storage["c" /* sessionStorageGetItem */])(constants["h" /* SESSION_STORAGE_RELOAD_AND_PROFILE_KEY */]) === 'true') {
      _this._recordChangeDescriptions = Object(storage["c" /* sessionStorageGetItem */])(constants["g" /* SESSION_STORAGE_RECORD_CHANGE_DESCRIPTIONS_KEY */]) === 'true';
      _this._isProfiling = true;
    ...
    var persistedSelectionString = Object(storage["c" /* sessionStorageGetItem */])(constants["f" /* SESSION_STORAGE_LAST_SELECTION_KEY */]);
