...
soter_status_t soter_asym_cipher_init(soter_asym_cipher_t* asym_cipher, const void* key,
                                      size_t key_length, soter_asym_cipher_padding_t pad);
...
soter_status_t soter_sign_init(soter_sign_ctx_t* ctx, soter_sign_alg_t algId,
                               const void* private_key, size_t private_key_length,
...
soter_status_t soter_hmac_init(soter_hmac_ctx_t* hmac_ctx, soter_hash_algo_t algo,
