...
typedef struct soter_sym_aead_ctx_type soter_sym_aead_ctx_t;
 ...
 * @return @ref SOTER_SUCCESS on success and @ref SOTER_FAIL on failure. 
 */
soter_status_t soter_sym_aead_encrypt_aad(soter_sym_aead_ctx_t *ctx, const void* plain_data,  const size_t data_length);
 ...
 * @note If cipher_data==NULL or cipher_data_length less then need to store cipher data, @ref SOTER_BUFFER_TOO_SMALL will return and cipher_data_length will contain length of buffer thet need to store cipher data.
 */
soter_status_t soter_sym_aead_encrypt_update(soter_sym_aead_ctx_t *ctx, const void* plain_data,  const size_t data_length, void* cipher_data, size_t* cipher_data_length);
 ...
 * @return @ref SOTER_SUCCESS on success and @ref SOTER_FAIL on failure. 
 */
soter_status_t soter_sym_aead_decrypt_aad(soter_sym_aead_ctx_t *ctx, const void* plain_data,  const size_t data_length);
 ...
 * @note If plain_data==NULL or plain_data_length less then need to store plain data, @ref SOTER_BUFFER_TOO_SMALL will return and plain_data_length will contain length of buffer thet need to store plain data.
 */
soter_status_t soter_sym_aead_decrypt_update(soter_sym_aead_ctx_t *ctx, const void* plain_data,  const size_t data_length, void* chiper_data, size_t* chipher_data_length);
