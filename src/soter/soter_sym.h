...
soter_sym_ctx_t* soter_aes_gcm_decrypt_create(const soter_sym_kdf_t, const void* key, const size_t key_length, const void* salt, const size_t salt_length, const void* auth_tag, const size_t auth_tag_length);
...
soter_status_t soter_aes_gcm_decrypt_final(soter_sym_ctx_t *ctx, void* chipher_data, size_t* chipher_data_length);
