...
#ifndef SOTER_EC_KEY_PAIR_GEN_H
#define SOTER_EC_KEY_PAIR_GEN_H

#include "soter_ec_key.h"

typedef struct soter_ec_key_pair_gen_type soter_ec_key_pair_gen_t;
