...
soter_status_t soter_verify(const void* private_key, const size_t private_key_length, const void* public_key, const size_t public_key_length, const int8_t* signed_data, const size_t signed_data_length, int8_t* data, size_t* data_length);
