...
class scell_full(object):
	...
	if themis.themis_secure_cell_encrypt_full(self.key ,len(self.key), message, len(message), None, byref(encrypted_message_length)) != -4:
	...
	if themis.themis_secure_cell_encrypt_full(self.key ,len(self.key), message, len(message), encrypted_message, byref(encrypted_message_length)) != 0:
	...
	if themis.themis_secure_cell_decrypt_full(self.key ,len(self.key), message, len(message), None, byref(decrypted_message_length)) != -4:
	...
	if themis.themis_secure_cell_decrypt_full(self.key ,len(self.key), message, len(message), decrypted_message, byref(decrypted_message_length)) != 0:
...
class scell_auto_split(object):
	...
	if themis.themis_secure_cell_encrypt_auto_split(self.key ,len(self.key), message, len(message), None, byref(context_length), None, byref(encrypted_message_length)) != -4:
	...
	if themis.themis_secure_cell_encrypt_auto_split(self.key ,len(self.key), message, len(message), context, byref(context_length), encrypted_message, byref(encrypted_message_length)) != 0:
	...
	decrypted_message_length=c_int(0);
	if themis.themis_secure_cell_decrypt_auto_split(self.key ,len(self.key), message, len(message), context, context_length, None, byref(decrypted_message_length)) != -4:
	    raise themis_exception("themis_secure_cell_decrypt_auto_split (decrypted message length determination) error");
	decrypted_message=create_string_buffer(decrypted_message_length.value);
	if themis.themis_secure_cell_decrypt_auto_split(self.key ,len(self.key), message, len(message), context, context_length, decrypted_message, byref(decrypted_message_length)) != 0:
