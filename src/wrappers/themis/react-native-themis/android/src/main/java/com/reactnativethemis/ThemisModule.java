...
public class ThemisModule extends ReactContextBaseJavaModule {
    ...
    private static int compareResultSerialize(SecureCompare.CompareResult result) {
        switch (result) {
        case NOT_READY:
            return comparator_not_ready;
        case NO_MATCH:
            return comparator_not_match;
        case MATCH:
            return comparator_match;
        default:
            return comparator_error;
        }
    }
    ...
    @ReactMethod
    public void stringSerialize(String text, Callback callback) {
