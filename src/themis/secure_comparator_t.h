 ...
 * g2, g3, P, Q       -> intermediate parameters of each peer while protocol execution (G2a, G3a,
 * Pa, Qa - for Alice; G2b, G3b, Pb, Qb - for Bob) Pp, g3p            -> intermediate parameters
 * received from your peer Qa_Qb              -> local temporary intermediate parameter
 *
 */
