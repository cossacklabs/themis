...
#define THEMIS_SECURE_MESSAGE_RSA_SIGNED           0x2601
#define THEMIS_SECURE_MESSAGE_EC_SIGNED            0x2602
#define THEMIS_SECURE_MESSAGE_RSA_ENCRYPTED        0x2701
#define THEMIS_SECURE_MESSAGE_EC_ENCRYPTED_AES_ECB 0x2702
#define THEMIS_SECURE_MESSAGE_EC_ENCRYPTED_AES_CBC 0x2703
#define THEMIS_SECURE_MESSAGE_EC_ENCRYPTED_AES_GCM 0x2704
#define THEMIS_SECURE_MESSAGE_EC_ENCRYPTED_AES_XTS 0x2705
