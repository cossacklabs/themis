 ...
 */
DEPRECATED("use 'themis_secure_message_encrypt' or 'themis_secure_message_sign' instead")
 ...
 */
DEPRECATED("use 'themis_secure_message_decrypt' or 'themis_secure_message_verify' instead")
