...
typedef ssize_t (*send_protocol_data_callback)(const uint8_t* data, size_t data_length,
                                               void* user_data);
/** @brief receive data callbeck tyoedef*/
typedef ssize_t (*receive_protocol_data_callback)(uint8_t* data, size_t data_length,
                                                  void* user_data);
...
typedef int (*get_public_key_for_id_callback)(const void* id, size_t id_length, void* key_buffer,
...
typedef themis_status_t (*secure_session_handler)(secure_session_t* session_ctx, const void* data,
