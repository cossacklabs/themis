...
#ifndef THEMIS_SECURE_MESSAGE_WRAPPER_ENC_DEC_CIPTHE_H
#define THEMIS_SECURE_MESSAGE_WRAPPER_ENC_DEC_CIPTHE_H
...
#endif //THEMIS_SECURE_MESSAGE_WRAPPER_ENC_DEC_CIPTHE_H
