...
themis_status_t themis_auth_sym_encrypt_message_(const uint8_t* key,
                                                 ...
                                                 size_t* encrypted_message_length)
{
    if (encrypted_message == NULL || (*encrypted_message_length) < message_length || out_context == NULL
        || (*out_context_length) < (sizeof(themis_auth_sym_message_hdr_t)
                                    + THEMIS_AUTH_SYM_IV_LENGTH + THEMIS_AUTH_SYM_AUTH_TAG_LENGTH)) {
    ...
    THEMIS_CHECK(themis_auth_sym_plain_encrypt(THEMIS_AUTH_SYM_ALG,
                                               key,
                                               key_length,
                                               iv,
                                                ...
                                                size_t* encrypted_message_length)
{
    ...
    THEMIS_STATUS_CHECK(themis_sym_kdf(key,
                                       ...
                                       sizeof(key_)),
                        THEMIS_SUCCESS);
    return themis_auth_sym_encrypt_message_(key_,
                                            sizeof(key_),
                                            message,
                                            message_length,
                                            in_context,
                                                 ...
                                                 size_t* message_length)
{
    ...
    THEMIS_CHECK(themis_auth_sym_plain_decrypt(hdr->alg,
                                               key,
                                               key_length,
                                               iv,
                                               hdr->iv_length,
                                                ...
                                                size_t* message_length)
{
    ...
    THEMIS_STATUS_CHECK(themis_sym_kdf(key,
                                       ...
                                       sizeof(key_)),
                        THEMIS_SUCCESS);
    themis_status_t decryption_result = themis_auth_sym_decrypt_message_(key_,
                                                                         sizeof(key_),
                                                                         in_context,
                                                                         in_context_length,
                                                                         context,
    ...
    if (sizeof(size_t) == sizeof(uint64_t)) {
        if (decryption_result != THEMIS_SUCCESS && decryption_result != THEMIS_BUFFER_TOO_SMALL) {
            ...
            THEMIS_STATUS_CHECK(themis_sym_kdf(key,
                                               ...
                                               sizeof(key_)),
                                THEMIS_SUCCESS);
            decryption_result = themis_auth_sym_decrypt_message_(key_,
                                                                 sizeof(key_),
                                                                 in_context,
                                                                 in_context_length,
                                                                 context,
